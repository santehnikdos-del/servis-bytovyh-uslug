...
export async function GET() {
  try {
    ...
    console.error("GET plumbing services error:", error);
...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.error("POST plumbing services error:", error);
...
export async function PUT(request: Request) {
  ...
  try {
    ...
    console.error("PUT plumbing services error:", error);
...
export async function DELETE(request: Request) {
  ...
  try {
    ...
    console.error("DELETE plumbing services error:", error);
