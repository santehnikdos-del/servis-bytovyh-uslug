...
export const metadata = {
  title: "Установка раковины в Алматы | Сервис бытовых услуг",
...
export default function UstanovkaRakovinyPage() {
  return (
      ...
      <section className="bg-sky-800 px-6 py-3 text-white md:py-3">
        <div className="mx-auto max-w-7xl">
          ...
          <h1 className="mt-2 max-w-5xl text-5xl font-black leading-tight md:text-6xl">
            Установка раковины в Алматы
          </h1>

          <p className="mt-3 max-w-3xl text-xl leading-8 text-slate-300">
            Установим или заменим раковину в ванной и кухонную мойку.
            Подключим сифон и смеситель, проверим соединения и устраним протечки.
          </p>
            ...
            {services.map((service) => (
              ...
              >
                ...
                <p className="mt-3 text-slate-600">
                  ...
                  проверяем все соединения после установки.
                </p>
              </div>
            ))}
          </div>
      ...
      <section className="bg-slate-100 py-12 text-slate-900">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 md:grid-cols-2">
          <div>
            ...
            <h2 className="mt-2 text-4xl font-black">
              Аккуратный монтаж и гарантия
            </h2>
          </div>

          <p className="text-lg leading-8 text-slate-600">
            Мастер приезжает в удобное время, помогает проверить совместимость
            оборудования, выполняет монтаж и оставляет после себя порядок.
          </p>
        </div>
      </section>
